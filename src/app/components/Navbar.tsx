    ...
    <header className="relative px-4 sm:px-6">
      <nav className="mx-auto flex max-w-7xl items-center justify-between py-4 px-2">
        ...
        <Link className="flex items-center justify-center" href={"/"}>
          ...
          <h1 className="font-lora font-bold text-2xl hidden sm:block">
          </h1>
        </div>
        <button className="border-raduis rounded-full bg-black text-white text-sm px-5 py-2"> Get started</button>
        {/* <WriteBlogButton /> */}
      </nav>
    </header>
  );
