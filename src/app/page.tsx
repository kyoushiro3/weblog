      ...
      <section className="mx-auto max-w-7xl py-16 px-2 lg:py-20">
        <div className="w-full flex flex-col gap-4">
          ...
          <div className="flex gap-3 mt-4">
            <button className="font-rubikborder-radius bg-black hover:bg-black rounded-full text-white text-sm px-5 py-2 dark:text-black dark:bg-white sm:flex items-center">
